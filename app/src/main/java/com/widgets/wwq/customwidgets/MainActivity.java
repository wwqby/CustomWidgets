...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bvBanner.initView(this,bannerLists);
//        BannerFragmentAdapter adapter=new BannerFragmentAdapter(getSupportFragmentManager(), bannerLists);
//        bvBanner.setAdapter(adapter);
